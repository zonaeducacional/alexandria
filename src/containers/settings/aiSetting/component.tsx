...
class AISetting extends React.Component<SettingInfoProps, SettingInfoState> {
  constructor(props: SettingInfoProps) {
    ...
    this.state = {
      ...
      aiTranslateModel: ConfigService.getReaderConfig("aiTranslateModel") || "agnes-ai-default",
      aiDictModel: ConfigService.getReaderConfig("aiDictModel") || "agnes-ai-default",
      aiAssistanceModel:
        ConfigService.getReaderConfig("aiAssistanceModel") || "agnes-ai-default",
      aiTranslatePrompt:
  ...
  getAIModels = () => {
    ...
    // Inject Agnes AI if not present
    if (!aiModels.some((m) => m.displayName === "Agnes AI")) {
      aiModels.unshift({
        key: "agnes-ai-default",
        displayName: "Agnes AI",
        config: {
          provider: "openai",
          endpoint: "/api/agnes/v1/",
          apiKey: "sk-will-be-injected-by-cloudflare",
